...
$address = $row["address"];
    ...
    $sql = "update form2 set name ='$name', email='$email', phone='$phone', address='$address' where id='$id'";
    $result = $conn->query($sql);
}
?>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
 ...
 <label>Phone:</label>
 <input type="phone" name="phone" value="<?php echo $phone; ?>" class="form-control"><br>

 <label>Address:</label>
 <input type="address" name="address" value="<?php echo $address; ?>" class="form-control"><br>
